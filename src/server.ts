...
export class App {
  ...
  constructor() {
    ...
    if (!fs.existsSync(`${process.cwd()}/${Constants.IMAIGE_ROOT_FOLDER}/${Constants.IMAIGE_SUB_FOLDER1}/`)) {
      fs.mkdirSync(`${process.cwd()}/${Constants.IMAIGE_ROOT_FOLDER}/${Constants.IMAIGE_SUB_FOLDER1}/`);
    }

    if (!fs.existsSync(`${process.cwd()}/${Constants.TEMP_FOLDER}/`)) {
      fs.mkdirSync(`${process.cwd()}/${Constants.TEMP_FOLDER}/`);
    }
